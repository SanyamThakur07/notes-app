...
export const createNotebook = async (values: InsertNotebook) => {
    try {
        ...
        return { success: false, message: "Failed to created notebook" };
    }
}
...
export const getNotebooks = async () => {
    try {
        ...
        const getNotebooksByUser = await db.query.notebooks.findMany({
...
export const updateNotebook = async (id: string, values: InsertNotebook) => {
    try {
        ...
        return { success: true, message: "Updated notebook successfully" };
    }
    catch {
...
export const deleteNotebook = async (id: string) => {
    try {
        ...
        return { success: false, message: "Failed to delelte notebook" };
    }
}